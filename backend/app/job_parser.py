...
from app.models import JobDescription,jobd_schema
...
def parse_job_description(job_description:str):
    ...
    """ 
    user_prompt=f"""
    Analyze the following job description and extract the requested structured information.
    Job Description:
    {job_description}
    """
    message_system ={
